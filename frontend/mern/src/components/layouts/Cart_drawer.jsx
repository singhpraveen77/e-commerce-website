...
export const Cart_drawer = () => {
  ...
  return (
    (
      <div className={`z-10 fixed top-0 right-0 w-1/4 h-full flex flex-col text-center bg-white shadow-lg transition-transform transform duration-3000 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
